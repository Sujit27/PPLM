...
SmallConst = 1e-15
enc = GPT2Tokenizer.from_pretrained('/content/drive/MyDrive/passage_generation_testing/gpt2-medium')
...
def run_model():
    ...
    parser.add_argument('--model_path', '-M', type=str, default='/content/drive/MyDrive/passage_generation_testing/gpt2-medium',
